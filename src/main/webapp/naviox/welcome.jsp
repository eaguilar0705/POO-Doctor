...
In ProyectoPOO-labels_en.properties:
ProyectoPOO=My application
ProyectoPOO[description]=My application does this and that

In ProyectoPOO-messages_en.properties:
